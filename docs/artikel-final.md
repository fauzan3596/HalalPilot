...
*Naskah final untuk Blogspot, revisi 19 September 2026 mengikuti struktur paper teknis (abstrak, kontribusi, rumusan masalah, arsitektur, metode, evaluasi, ancaman validitas, referensi bernomor) dengan tetap memenuhi syarat artikel AI HackFest 2026. Ditulis dari SPECS, ROADMAP, bukti uji 10 September, dan verifikasi ulang angka pada 19 September. Tanda `[…]` diisi saat tayang. Gambar ada di `docs/artikel/img/`.*
