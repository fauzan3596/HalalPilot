...
- [x] v3 (19 Sep): `HalalPilot-demo-v3.mp4` 9:24 — narasi edge-tts id-ID terkunci ke peristiwa di layar (anchor detik sumber + frame beku), caption mengikuti suara, watermark logo IDwebhost asli, bagian email berisi sandi VPS dibuang; IP VPS & id Telegram sengaja dibiarkan (bukti VPS)
