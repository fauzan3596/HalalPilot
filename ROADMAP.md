...
- [x] v4 (19 Sep): Remotion (`docs/video/remotion`) — pembuka animasi 4%, judul adegan meluncur + progres, caption beranimasi dengan sorot angka, zoom 10 peristiwa kunci, transisi silang, penutup bertahap; `Videos/HalalPilot-edit/HalalPilot-demo-v4.mp4` 9:34, 128 MB
